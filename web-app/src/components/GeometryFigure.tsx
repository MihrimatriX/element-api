...
function Bond({ x1, y1, x2, y2 }: { x1: number; y1: number; x2: number; y2: number }) {
  return <line x1={x1} y1={y1} x2={x2} y2={y2} stroke="currentColor" strokeWidth="1.8" />;
}
...
const SHAPE: Record<GeometryKind, ReactNode> = {
  ...
  ionic_lattice: (
    <>
      <rect x={12} y={10} width={24} height={16} fill="none" stroke="currentColor" strokeWidth="1.6" />
      <rect x={44} y={10} width={24} height={16} fill="none" stroke="currentColor" strokeWidth="1.6" />
      <rect x={12} y={30} width={24} height={16} fill="none" stroke="currentColor" strokeWidth="1.6" />
      <rect x={44} y={30} width={24} height={16} fill="none" stroke="currentColor" strokeWidth="1.6" />
      <Node x={24} y={18} r={4} />
      <Node x={56} y={18} r={4} />
      <Node x={24} y={38} r={4} />
      <Node x={56} y={38} r={4} />
