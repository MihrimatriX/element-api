...
export default function ScientificDetail({
  ...
  return (
    <main className="science-detail atlas-detail">
      <Seo
      ...
      <div className="science-detail-layout">
        <aside className="science-detail-nav">
          ...
          {element && (
            <div className="science-market-links">
              <p>Kredi simülasyonu</p>
              <Link to={`/market?symbol=${mark}`}>Piyasa</Link>
              <Link to={`/shop?symbol=${mark}`}>Mağaza</Link>
            </div>
          )}
        </aside>
