    ...
    <main className="science-detail lab-page">
      ...
      <header className="lab-heading">
        <div>
          <h1>Formülü kur</h1>
          <p>
            Adı verilen kaydı sayılarla kur. Sürükleme yok; artı eksi yeter.
            Skor deftere yazılmaz — sadece pratik.
          </p>
        </div>
        <div className="lab-progress">
          ...
          <span>doğru formül · seviye {tier}</span>
        </div>
      </header>
      <LabModes />
      <Card asChild className="gap-0 py-5 max-md:py-3 shadow-none">
        <section className="lab-bench" aria-label="Formül kurma">
          <div className="lab-bench-top">
            <h2 className="lab-bench-label">Kurulacak kayıt</h2>
            <Button
              variant="plain"
              size="none"
              className="lab-clear"
          ...
          {done && (
            <div className="lab-result-actions">
              <Link to={`/compound/${target.slug}`}>Bilimsel kaydı aç</Link>
              <Button
                variant="plain"
                size="none"
                onClick={() => nextPuzzle(solved)}
              >
