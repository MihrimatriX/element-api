...
export default function DataCoverage() {
  return (
    <main className="science-detail void-page void-enter">
      <Seo
        ...
        path="/data"
      />
      <p className="void-kicker">Kaynak</p>
      <h1>Kaynaklar ve veri kapsamı</h1>
      <p className="lead">
        {coverage.elements} element, {coverage.compounds} bileşik. Sayı PubChem
        / RSC / NIST’ten; Türkçe cümle bizden. Yoksa null — suyun erime noktası
        uydurulmaz.
      </p>
      ...
      <h2>Bu sürüm</h2>
      <dl className="coverage-facts void-stagger">
        <div>
