...
const GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        term: "Bileşik",
        mark: "H₂O",
        try: { to: "/compounds", label: "167 kayda bak" },
        def: "Birden fazla elementin bilinen bir oranı. Su H₂O, sofra tuzu NaCl, pasın hikâyesi demir oksitler. Kataloğumuzda 167 kayıt var; hayali molekül yok.",
      },
      {
        term: "Molekül",
        mark: "H₂O",
      ...
      },
      {
        term: "Oksiasit",
        mark: "H₂SO₄",
        try: { to: "/lab/formula?compound=h2so4", label: "Asidin formülünü kur" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        term: "KREDI",
        mark: "KREDI",
        try: { to: "/demo", label: "Simülasyonu tanı" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        def: "Miktar birimi. Mağaza paketleri 1 / 10 / 100 gram. Eğitim kataloğundaki 167 molekül otomatik satılık ürün olmaz.",
      },
    ],
  },
];
...
export default function Glossary() {
  ...
  return (
    <main className="page explainer-page glossary-page">
      <Seo
      ...
      <div className="explainer">
        <article className="explainer-prose">
          ...
          <h1>Sözlük</h1>
          <p className="lead">
            Sayfada geçen sözler. Su, tuz, pas. Ders kitabı değil; tezgâhın kenarına
            yazılmış not.
          </p>
        ...
        <aside className="explainer-aside">
          <div className="def-card">
            <p className="kicker">İlk üç söz</p>
