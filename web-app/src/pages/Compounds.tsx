...
export default function Compounds() {
  ...
  return (
    <main className="science-detail compounds-catalog">
      <Seo
      ...
      <section className="explorer-heading">
        <div>
          <h1>Bileşikler</h1>
          <p>
            Su, tuz, pas: 214 kayıt. Formül birimi ile molekül karışmaz; ad,
            formül veya grupla süz.
          </p>
        </div>
      ...
      {filtered.length === 0 && (
        <div className="learning-empty compound-empty" role="status">
          <p>Bu süzgeçte kayıt yok. Su hâlâ H₂O, tuz hâlâ NaCl.</p>
