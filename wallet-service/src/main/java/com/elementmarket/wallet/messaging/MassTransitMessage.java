...
public final class MassTransitMessage {
    ...
    public static byte[] publishBody(ObjectMapper mapper, String typeName, ObjectNode payload) throws Exception {
        return publishBody(mapper, typeName, payload, UUID.randomUUID().toString());
    }

    public static byte[] publishBody(ObjectMapper mapper, String typeName, ObjectNode payload, String messageId)
            throws Exception {
