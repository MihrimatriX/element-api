...
export async function searchOrdersByCustomer(params) {
    ...
    const res = await pool.query(`SELECT * FROM orders WHERE ${where} ORDER BY created_at DESC LIMIT $${idx++} OFFSET $${idx}`, values);
